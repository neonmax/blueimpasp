...
<script language="C#" runat="server">    
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.HttpMethod.ToUpper() == HttpMethods.GET && FullFileName == null)
        {
        ...
        else if (Request.HttpMethod.ToUpper() == HttpMethods.POST)
        {
            ...
            for (int FileIndex = 0; FileIndex < Request.Files.Count; FileIndex++)
            {
                ...
                FileName = String.Format(@"{0}\{1}", FilesPath, fileNameWithoutExt+ext);
        ...
        else if (Request.HttpMethod.ToUpper() == HttpMethods.GET && FullFileName != null)
        {
